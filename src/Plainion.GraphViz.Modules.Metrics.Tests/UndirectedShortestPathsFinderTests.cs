...
{
    [Test]
    public void SingleEdge_ReturnsOnePath()
    {
    ...
    [Test]
    public void TriangleGraph_ReturnsAllPathsWithoutCycles()
    {
        var builder = new RelaxedGraphBuilder();
        builder.TryAddEdge("A", "B");
    ...
    public void WeightedEdges_IgnoresWeights()
    {
        ...
        builder.TryAddEdge("A", "B");
        builder.TryAddEdge("B", "C");
        builder.TryAddEdge("A", "C"); // Weight ignored, still 1 hop
    ...
    [Test]
    public void DiamondGraph_FindsShortestPaths()
    {
        var builder = new RelaxedGraphBuilder();
        builder.TryAddEdge("A", "B");
