    ...
    class ClusterVisual : AbstractElementVisual
    {
        ...
        public void Draw(IDictionary<string, AbstractElementVisual> drawingElements)
        {
            ...
            var tx = new FormattedText(caption.DisplayText,
                  ...
                  myFont,
                  FontSize, Themes.Current.CaptionColor(Brushes.Black));
            ...
            dc.DrawRectangle(Brushes.Transparent, new Pen(Themes.Current.ClusterBorderColor(Brushes.Blue), BorderThickness), rect);
        ...
        {
            return Themes.Current.ClusterBorderColor(Brushes.Blue);
        }
    }
}
