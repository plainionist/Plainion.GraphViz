...
{
    class PackagingGraphInspector : AsyncInspectorBase<TypeRelationshipDocument>
    {
        private string mySelectedAssemblyName;

        public PackagingGraphInspector(string applicationBase)
        ...
        public override TypeRelationshipDocument Execute()
        {
            ...
            var builder = new PackagingGraphBuilder();
        ...
        private void ProcessAssembly(TypeRelationshipDocument document, PackagingGraphBuilder builder, string assemblyFile)
        {
            try
            {
