...
namespace Plainion.GraphViz.Modules.SDK.Analysis1
{
    class ConfigurationViewModel : ViewModelBase
    {
        ...
        private void OnAnalysisCompleted(AnalysisDocument document)
        {
            ...
            // TODO: build the graph using the builder

            // TODO: presentation modules to set styles for the graph

            presentation.Graph = builder.Graph;

            // TODO: uye the StatusMessageService to report any issues occurred during analysis
